...
start "" "C:\Program Files\Epic Games\UE_5.7\Engine\Binaries\Win64\UnrealEditor.exe" "C:\3d\WarpalaUE5\WarpalaUE5.uproject" -game -ResX=1280 -ResY=720 -AudioMixer -PixelStreamingURL="ws://127.0.0.1:8888" -RenderOffScreen
