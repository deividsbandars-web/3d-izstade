...
Intent:
- delete the checked-in duplicate artifact `src/backend/marketplace/installService.js` while preserving the canonical TypeScript implementation
...
- next recommendation: `MARKETPLACE INSTALL SERVICE STABILIZATION REVIEW`
