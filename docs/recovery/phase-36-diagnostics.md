...
- controller/expo/distribution/platform/agents files scanned: `55`
...
- deleted `src/backend/agents/runners/marketingRunner.js`
- `docs/recovery/phase-36-agents-runner-duplicate-burn-down-3.md`
- `docs/recovery/phase-36-diagnostics.md`
...
- no worker, subscriber, package script, or dynamic-import path required a physical `marketingRunner.js` source file

## Remaining Risks

- agents duplicate debt still exists in `agentTools` and `salesRunner`
