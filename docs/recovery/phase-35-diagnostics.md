...
- deleted `src/backend/agents/runners/leadRunner.js`
- `docs/recovery/phase-35-agents-runner-duplicate-burn-down-2.md`
- `docs/recovery/phase-35-diagnostics.md`
...
- no worker, subscriber, package script, or dynamic-import path required a physical `leadRunner.js` source file

## Remaining Risks

- agents duplicate debt still exists in `agentTools`, `marketingRunner`, and `salesRunner`
