# Phase 79 Diagnostics

## Commands Run

Pre-delete audit:

- `rg -n --glob '!docs/**' --glob '!diagnostics/**' --glob '!dist/**' --glob '!node_modules/**' "leadSourceCollectionService\\.js|leadSourceCollectionService\\.ts|import\\(|dynamic import|worker" C:\\3d\\src C:\\3d\\backend-server C:\\3d\\scripts`
- `Get-Content C:\\3d\\src\\backend\\leads\\engine\\leadEngine.ts`
- `Get-Content C:\\3d\\src\\backend\\leads\\engine\\leadEngine.js`
...
- removed `src/backend/leads/sources/leadSourceCollectionService.js`
...
`leadSourceCollectionService.js` was only referenced by:
