# Phase 49 Diagnostics

## Scope

- Expanded `src/backend/billing/billingApplicationService.ts`
- Rewired `src/backend/ai/llmService.ts`
- Rewired `src/backend/ai/llmService.js`
- Hardened `scripts/check-backend-boundaries.mjs` for AI -> usage/cost direct-import regressions
...
## Remaining Billing Usage Warnings
