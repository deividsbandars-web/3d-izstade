      ...
      >
        ...
        >
          ...
          <div style={{ color: '#f8fafc', fontSize: '0.8rem', fontWeight: 900, lineHeight: 1.12 }}>
            {currentViewMode === 'interior' ? 'Modular home interior' : 'Modular home studio'}
          </div>
          <div style={{ color: '#cbd5e1', fontSize: '0.6rem', fontWeight: 700, lineHeight: 1.3 }}>
            {currentViewMode === 'interior'
              ? 'Walk inside the GALA home, review finishes, and request a quote from the studio panel.'
              : 'Explore the GALA home, change exterior and interior details, and request a quote.'}
          </div>
