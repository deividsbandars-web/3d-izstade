export type ExpoMode = 'menu' | 'walk' | 'fly';
...
export const PRODUCTION_SAFE_COMPANIES = [
  ...
  },
  {
    ...
    posterUrl: '/expo/media/warpala-expo-city-camera-view.png',
    ...
    booth: {
      ...
      posterUrl: '/expo/media/warpala-expo-city-camera-view.png',
      heroAssetUrl: '/models/bridge_design.glb',
      heroScreenSlotId: 'city-sponsor-boulevard-right-screen',
      heroScreenStatus: 'published',
      heroScreenType: 'image',
      heroScreenTitle: 'Warpala City Camera',
      heroScreenText: 'Web3D Expo walkthrough view',
      heroScreenImageUrl: '/expo/media/warpala-expo-city-camera-view.png',
      ctaLabel: 'Book Meeting',
      boothType: 'premium',
    },
  },
...
export const EXPO_MODE_COPY = {
  title: 'WARPALA',
  subtitle: 'WEB3D EXPO CITY',
  publicLabel: 'Public / lightweight:',
  publicDescription: 'Walk the sponsor boulevard, open booth profiles, and switch into the modular-home studio from the city shell.',
  boothLabel: 'Booth profile:',
  boothDescription: 'Booth profiles open sponsor details and contact actions in this build.',
  fallbackLabel: 'Booth access:',
  cityFallbackDescription: 'If a booth does not yet have an interactive room, continue in the public expo city or open the booth profile.',
  walkCta: 'WALK CITY',
  flyCta: 'FLY OVERVIEW',
  modularHomesCta: 'APSKATĪT MODULĀRO MĀJU',
  backToDashboard: 'BACK TO EXPO',
  publicModeBadge: 'WEB3D EXPO',
  exitToLobby: 'RETURN TO EXPO',
  boothStatusLabel: 'Booth status:',
  boothAvailable: 'Available. Booth profiles are open from the city.',
  boothUnavailable: 'Booth profile is unavailable. Use the public expo city.',
  boothStatusCheckedAt: 'Checked at:',
  boothStatusWarningsLabel: 'Warnings:',
} as const;
