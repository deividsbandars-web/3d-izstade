...
export const PRODUCTION_SAFE_COMPANIES = [
  ...
  },
  {
    ...
    booth: {
      ...
      posterUrl: '/expo/media/warpala-expo-city-camera-view.png',
      heroAssetUrl: '/models/bridge_design.glb',
      cityScreenSlotId: 'city-sponsor-boulevard-right-screen',
      cityScreenStatus: 'published',
      cityScreenType: 'image',
      cityScreenTitle: 'Warpala City Camera',
      cityScreenText: 'Web3D Expo walkthrough view',
      cityScreenImageUrl: '/expo/media/warpala-expo-city-camera-view.png',
      ctaLabel: 'Book Meeting',
      boothType: 'premium',
    },
  },
...
export const EXPO_MODE_COPY = {
  title: 'Warpala Expo',
  subtitle: 'Sponsor Boulevard',
  publicLabel: 'Explore:',
  publicDescription: 'Walk the sponsor boulevard, visit booths, view city screens, and open the modular-home studio.',
  boothLabel: 'Sponsor booths:',
  boothDescription: 'See sponsor offers, media, contact actions, and booth packages in one city view.',
  fallbackLabel: 'Need a booth?',
  cityFallbackDescription: 'Choose a booth package, provide brand assets, preview the booth, and request setup.',
  walkCta: 'Walk city',
  flyCta: 'Overview',
  modularHomesCta: 'View modular home',
  backToDashboard: 'Back',
  publicModeBadge: 'Sponsor Expo',
  exitToLobby: 'Menu',
  boothStatusLabel: 'Booth status:',
  boothAvailable: 'Booth profile is available.',
  boothUnavailable: 'Booth profile is not available yet. Continue exploring the city.',
