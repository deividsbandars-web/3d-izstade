...
assertVectorClose(resolvedLeftCivilizationMonumentView.lookAt, [-900, 1240, 431.8]);
assertVectorClose(resolvedLeftCivilizationMonumentView.position, [4000, 560, 8631.8]);
