...
assert.equal(premiumLayout.mediaSurfaceCount, 2);
assert.ok(premiumLayout.screenFrameWidth / premiumLayout.width >= 0.89);
assert.ok(premiumLayout.screenSurfaceWidth / premiumLayout.screenFrameWidth >= 0.9);
assert.ok(premiumLayout.screenSurfaceHeight / premiumLayout.screenFrameHeight >= 0.86);
...
assert.equal(eliteLayout.mediaSurfaceCount, 2);
assert.ok(eliteLayout.screenSurfaceWidth / eliteLayout.screenFrameWidth >= 0.9);
