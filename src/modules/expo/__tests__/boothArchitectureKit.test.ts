...
assert.equal(premiumLayout.showSignalTowers, true);
...
assert.ok(premiumLayout.signalTowerHeight > premiumLayout.screenFrameHeight);
...
assert.equal(eliteLayout.showSignalTowers, true);
...
assert.ok(eliteLayout.signalTowerHeight > eliteLayout.screenFrameHeight);
assert.ok(eliteLayout.signalTowerOffsetX > eliteLayout.screenFrameWidth * 0.5);
...
assert.equal(heroLayout.showSignalTowers, true);
...
assert.ok(heroLayout.signalTowerHeight > heroLayout.screenFrameHeight);
assert.ok(heroLayout.signalTowerOffsetX > heroLayout.screenFrameWidth * 0.5);
