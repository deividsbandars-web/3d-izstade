...
assert.deepEqual(groundNodes[2]?.targetPosition, [1260, 450, -1015]);
assert.equal(towerNodes[1]?.targetLevel, 'ground');
assert.deepEqual(towerNodes[1]?.position, [1260, 446, -1015]);
assert.deepEqual(towerNodes[1]?.targetPosition, [1260, 5, -955]);
assert.equal(towerNodes[2]?.targetLevel, 'skydeck');
assert.deepEqual(towerNodes[2]?.position, [1334, 446, -1015]);
assert.deepEqual(towerNodes[2]?.targetPosition, [1380, 1182, -1020]);
assert.equal(skydeckNodes[0]?.targetLevel, 'tower');
assert.deepEqual(skydeckNodes[0]?.position, [1380, 1178, -1020]);
assert.deepEqual(skydeckNodes[0]?.targetPosition, [1260, 450, -1015]);
assert.equal(groundNodes[3]?.targetLevel, 'tower');
assert.deepEqual(groundNodes[3]?.position, [1488, 0.25, -1015]);
assert.deepEqual(groundNodes[3]?.targetPosition, [1488, 744, -1062]);
assert.equal(groundNodes[4]?.targetLevel, 'tower');
assert.deepEqual(groundNodes[4]?.position, [1065, 0.25, -1368]);
assert.deepEqual(groundNodes[4]?.targetPosition, [1120, 562, -1424]);
assert.equal(towerNodes[3]?.targetLevel, 'ground');
assert.deepEqual(towerNodes[3]?.position, [1488, 740, -1062]);
assert.deepEqual(towerNodes[3]?.targetPosition, [1488, 5, -1015]);
assert.equal(towerNodes[4]?.targetLevel, 'skydeck');
assert.deepEqual(towerNodes[4]?.position, [1454, 740, -1062]);
assert.deepEqual(towerNodes[4]?.targetPosition, [1380, 1182, -1020]);
assert.equal(towerNodes[5]?.targetLevel, 'ground');
assert.deepEqual(towerNodes[5]?.position, [1120, 558, -1424]);
assert.deepEqual(towerNodes[5]?.targetPosition, [1065, 5, -1368]);
assert.equal(skydeckNodes[1]?.targetLevel, 'tower');
assert.deepEqual(skydeckNodes[1]?.position, [1338, 1178, -1020]);
assert.deepEqual(skydeckNodes[1]?.targetPosition, [1488, 744, -1062]);
...
assert.deepEqual(towerWalkableRegions[1]?.position, [1260, 450, -1015]);
assert.deepEqual(towerWalkableRegions[1]?.size, [220, 58]);
assert.equal(towerWalkableRegions[1]?.playerY, 450);
assert.deepEqual(towerWalkableRegions[2]?.position, [1488, 744, -1062]);
assert.deepEqual(towerWalkableRegions[2]?.size, [104, 58]);
assert.equal(towerWalkableRegions[2]?.playerY, 744);
assert.deepEqual(towerWalkableRegions[3]?.position, [1120, 562, -1424]);
assert.deepEqual(towerWalkableRegions[3]?.size, [124, 54]);
assert.equal(towerWalkableRegions[3]?.playerY, 562);
assert.deepEqual(skydeckWalkableRegions[0]?.position, [1380, 1182, -1020]);
assert.deepEqual(skydeckWalkableRegions[0]?.size, [164, 96]);
assert.equal(skydeckWalkableRegions[0]?.playerY, 1182);
