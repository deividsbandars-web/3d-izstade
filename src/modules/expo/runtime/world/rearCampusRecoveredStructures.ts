...
export const RECOVERED_REAR_CAMPUS_PHYSICS_PARTS_BY_ID: Readonly<Record<string, RecoveredRearCampusPhysicsPart[]>> = {
  ...
  'rear-campus-entry-pulse-arches': [
    ...
    { id: 'upper-arch-beam', localPosition: [0, 474, 0], size: [1900, 56, 92], walkableTop: false },
    { id: 'rear-lightline', localPosition: [0, 414, -96], size: [1640, 24, 34], walkableTop: false },
    { id: 'front-lightline', localPosition: [0, 414, 96], size: [1640, 24, 34], walkableTop: false },
  ],
};
