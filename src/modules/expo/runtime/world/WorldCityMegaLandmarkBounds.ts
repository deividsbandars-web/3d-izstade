...
export function buildWorldCityMegaLandmarkBounds({
  ...
  return [
    ...
    createMegaLandmarkBound({ id: 'mega-landmark-media-frame-wall', planningSection: 'middle', planningZone: 'center-spine', position: [760, 122, mediaBaseZ - 148], size: [296, 244, 70] }),
