...
export const BOOTH_PRODUCT_PROFILES = [
  {
    ...
    featureBullets: [
      'Meeting-oriented sponsor profile readiness',
      'CTA metadata for demo requests and future qualification',
      'Future lead scoring and AI-guided sponsor follow-up placeholders',
    ],
    heroMessage: 'Sponsor booth profile for meetings, demo requests and future AI-guided qualification.',
    ...
    packageTier: 'premium',
    shortPitch: 'A sponsor booth profile concept focused on sponsor conversion, CTA readiness and future lead scoring.',
  ...
  },
  {
    ...
    notes: 'Mock Booth Profile; diagnostic and lead capture are metadata-only.',
    packageTier: 'premium',
    shortPitch: 'A sponsor profile prepared for future diagnostic and meeting workflows.',
