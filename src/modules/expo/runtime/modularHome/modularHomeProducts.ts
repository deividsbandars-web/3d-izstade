...
export const MODULAR_HOME_OPTIONS = [
  ...
  {
    id: 'option-kitchen-finish-white',
    group: 'kitchenFinish',
    label: 'White kitchen finish',
    materialIds: ['interior-plywood'],
    priceDelta: 0,
    visualToken: 'white' satisfies ModularHomeConfiguratorState['kitchenFinish'],
    compatibleProducts: ALL_MODULAR_HOME_PRODUCT_IDS,
    requiredModuleIds: [],
  },
  {
    id: 'option-kitchen-finish-wood',
    group: 'kitchenFinish',
    label: 'Wood kitchen finish',
    materialIds: ['interior-plywood'],
    priceDelta: 600,
    visualToken: 'wood' satisfies ModularHomeConfiguratorState['kitchenFinish'],
    compatibleProducts: ALL_MODULAR_HOME_PRODUCT_IDS,
    requiredModuleIds: [],
  },
  {
    id: 'option-kitchen-finish-dark',
    group: 'kitchenFinish',
    label: 'Dark kitchen finish',
    materialIds: ['interior-plywood'],
    priceDelta: 900,
    visualToken: 'dark' satisfies ModularHomeConfiguratorState['kitchenFinish'],
    compatibleProducts: ALL_MODULAR_HOME_PRODUCT_IDS,
    requiredModuleIds: [],
  },
  {
    id: 'option-furniture-mood-minimal',
    group: 'furnitureMood',
    label: 'Minimal furniture mood',
    materialIds: ['interior-plywood'],
    priceDelta: 0,
    visualToken: 'minimal' satisfies ModularHomeConfiguratorState['furnitureMood'],
    compatibleProducts: ALL_MODULAR_HOME_PRODUCT_IDS,
    requiredModuleIds: [],
  },
  {
    id: 'option-furniture-mood-warm',
    group: 'furnitureMood',
    label: 'Warm furniture mood',
    materialIds: ['interior-plywood'],
    priceDelta: 650,
    visualToken: 'warm' satisfies ModularHomeConfiguratorState['furnitureMood'],
    compatibleProducts: ALL_MODULAR_HOME_PRODUCT_IDS,
    requiredModuleIds: [],
  },
  {
    id: 'option-furniture-mood-premium',
    group: 'furnitureMood',
    label: 'Premium compact mood',
    materialIds: ['interior-plywood'],
    priceDelta: 1400,
    visualToken: 'premiumCompact' satisfies ModularHomeConfiguratorState['furnitureMood'],
    compatibleProducts: ALL_MODULAR_HOME_PRODUCT_IDS,
    requiredModuleIds: [],
  },
  {
    id: 'option-interior-zone-focus-overview',
    group: 'interiorZoneFocus',
    label: 'Overview',
    materialIds: [],
    priceDelta: 0,
    visualToken: 'overview' satisfies ModularHomeConfiguratorState['interiorZoneFocus'],
    compatibleProducts: ALL_MODULAR_HOME_PRODUCT_IDS,
    requiredModuleIds: [],
  },
  {
    id: 'option-interior-zone-focus-living',
    group: 'interiorZoneFocus',
    label: 'Living',
    materialIds: [],
    priceDelta: 0,
    visualToken: 'living' satisfies ModularHomeConfiguratorState['interiorZoneFocus'],
    compatibleProducts: ALL_MODULAR_HOME_PRODUCT_IDS,
    requiredModuleIds: [],
  },
  {
    id: 'option-interior-zone-focus-kitchen',
    group: 'interiorZoneFocus',
    label: 'Kitchen',
    materialIds: [],
    priceDelta: 0,
    visualToken: 'kitchen' satisfies ModularHomeConfiguratorState['interiorZoneFocus'],
    compatibleProducts: ALL_MODULAR_HOME_PRODUCT_IDS,
    requiredModuleIds: [],
  },
  {
    id: 'option-interior-zone-focus-sleeping',
    group: 'interiorZoneFocus',
    label: 'Sleeping',
    materialIds: [],
    priceDelta: 0,
    visualToken: 'sleeping' satisfies ModularHomeConfiguratorState['interiorZoneFocus'],
    compatibleProducts: ALL_MODULAR_HOME_PRODUCT_IDS,
    requiredModuleIds: [],
  },
  {
    id: 'option-interior-zone-focus-bathroom',
    group: 'interiorZoneFocus',
    label: 'Bathroom',
    materialIds: [],
    priceDelta: 0,
    visualToken: 'bathroom' satisfies ModularHomeConfiguratorState['interiorZoneFocus'],
    compatibleProducts: ALL_MODULAR_HOME_PRODUCT_IDS,
    requiredModuleIds: [],
  },
  {
