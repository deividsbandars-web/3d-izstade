...
export const BOOTH_TIER_CONTRACT: Record<BoothCommercialTier, BoothTierContractSpec> = {
  ...
  premium: {
    ctaVerb: 'present',
    frontApronDepth: 3.9,
    frontApronWidth: 21.8,
    infoBandHeightWithTagline: 3.96,
    infoBandHeightWithoutTagline: 2.76,
    infoBandWidthPadding: 4.9,
    landmarkCue: 'portal',
  ...
  elite: {
    ctaVerb: 'host',
    frontApronDepth: 5,
    frontApronWidth: 26.8,
    infoBandHeightWithTagline: 4.8,
    infoBandHeightWithoutTagline: 3.46,
  ...
  hero: {
    ctaVerb: 'anchor',
    frontApronDepth: 6.2,
    frontApronWidth: 32.4,
    infoBandHeightWithTagline: 5.18,
    infoBandHeightWithoutTagline: 3.82,
    infoBandWidthPadding: 7.8,
...
export function buildBoothTierState({
  ...
  const fullUiDistance = skylineDensityEnabled ? 72 : 64;
