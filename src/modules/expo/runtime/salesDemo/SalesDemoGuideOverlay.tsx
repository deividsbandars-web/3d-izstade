import { isSalesDemoEnabled } from './salesDemoFlags';
        ...
        {GUIDE_ITEMS.map((item, index) => (
          ...
          >
            ...
            <div style={{ minWidth: 0 }}>
              <div style={{ color: '#f8fafc', fontSize: isTouchDevice ? '0.7rem' : '0.76rem', fontWeight: 900 }}>
                {item.label}
              </div>
              <div style={{ color: '#cbd5e1', fontSize: isTouchDevice ? '0.62rem' : '0.66rem', fontWeight: 650, lineHeight: 1.28 }}>
                {item.body}
              </div>
            </div>
          </div>
