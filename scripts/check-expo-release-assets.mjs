...
const criticalAssets = [
  { path: 'public/models/realistic_city.glb', budgetBytes: 25 * 1024 * 1024, type: 'city_backdrop' },
  { path: 'public/models/modern_evening_street_4k.exr', budgetBytes: 90 * 1024 * 1024, type: 'environment_exr' },
  { path: 'public/textures/pergola_walkway_4k.exr', budgetBytes: 90 * 1024 * 1024, type: 'ground_surface_exr' },
  { path: 'public/models/simple_grass_chunks.glb', budgetBytes: 25 * 1024 * 1024, type: 'ground_framing' },
  { path: 'public/models/construction_assets.glb', budgetBytes: 15 * 1024 * 1024, type: 'release_fallback_model' },
];
...
const report = {
  ...
  releasePathAssetBudgetMiB: criticalResults.reduce((total, asset) => total + asset.sizeMiB, 0),
  status: failingAssets.length === 0 ? 'pass' : 'fail',
};
